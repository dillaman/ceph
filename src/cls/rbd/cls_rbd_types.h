...
struct ParentImageSpec {
  int64_t pool_id = -1;           ///< parent pool id
  std::string pool_namespace;     ///< parent pool namespace
  std::string image_id;           ///< parent image id
  snapid_t snap_id = CEPH_NOSNAP; ///< parent snapid we refer to
