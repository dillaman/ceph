...
class LockerContext : public MDSInternalContext {
  protected:
  Locker *locker;
...
void Locker::eval_gather(SimpleLock *lock, bool first, bool *pneed_issue, list<MDSInternalContext*> *pfinishers)
{
...
bool Locker::eval(CInode *in, int mask, bool caps_imported)
{
  ...
  list<MDSInternalContext*> finishers;
...
bool Locker::rdlock_try(SimpleLock *lock, client_t client, MDSInternalContext *con)
{
 ...
 * inode.dirstat.
 */
void Locker::scatter_nudge(ScatterLock *lock, MDSInternalContext *c, bool forcelockchange)
{
