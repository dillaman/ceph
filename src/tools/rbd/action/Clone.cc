...
int execute(const po::variables_map &vm) {
  ...
  int r = utils::get_pool_image_snapshot_names(
    vm, at::ARGUMENT_MODIFIER_SOURCE, utils::get_positional_argument(vm, 0),
  ...
  r = utils::get_pool_image_snapshot_names(
    vm, at::ARGUMENT_MODIFIER_DEST, utils::get_positional_argument(vm, 1),
    &dst_pool_name, &dst_image_name, &dst_snap_name,
...
Shell::Action action(
  {"clone"}, {}, "Clone a snapshot into a COW child image.", "", &get_arguments,
  &execute);
