...
TEST_F(TestClsRbd, mirror) {
  ...
  ASSERT_EQ(-EINVAL, mirror_peer_add(&ioctx, "uuid1", "cluster1", 123,
                                     "client"));
  ...
  ASSERT_EQ(0, mirror_peer_add(&ioctx, "uuid1", "cluster1", 123, "client"));
  ASSERT_EQ(0, mirror_peer_add(&ioctx, "uuid2", "cluster2", 234, "admin"));
  ASSERT_EQ(-EEXIST, mirror_peer_add(&ioctx, "uuid2", "cluster3", 345, "foo"));
  ASSERT_EQ(-EEXIST, mirror_peer_add(&ioctx, "uuid3", "cluster1", 345, "foo"));
  ASSERT_EQ(0, mirror_peer_add(&ioctx, "uuid3", "cluster3", 234, "admin"));
